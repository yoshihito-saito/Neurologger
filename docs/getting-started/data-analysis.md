...
| Task | Script |
| --- | --- |
| Header and time correction | [`WILD_PreProcess.m`](https://github.com/zifangzhao/Neurologger/blob/main/Code/WILD_PreProcess.m) |
| IMU processing | [`WILD_processIMU.m`](https://github.com/zifangzhao/Neurologger/blob/main/Code/WILD_processIMU.m) |
| Camera decode with audio | [`WILD_VideoDecodewAudio.py`](https://github.com/zifangzhao/Neurologger/blob/main/Code/WILD_VideoDecodewAudio.py) |
| Intan header generation | [`WILD_genIntanHeader.m`](https://github.com/zifangzhao/Neurologger/blob/main/Code/WILD_genIntanHeader.m) |
